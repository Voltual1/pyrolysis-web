...
val Phosphor.CurrencyCircleDollar: ImageVector
    get() {
        if (_currency_circle_dollar != null) {
            return _currency_circle_dollar!!
        }
        _currency_circle_dollar = Builder(
...
private var _currency_circle_dollar: ImageVector? = null
