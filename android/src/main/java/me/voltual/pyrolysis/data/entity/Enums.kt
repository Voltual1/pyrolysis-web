...
import me.voltual.pyrolysis.HELP_CHANGELOG
import me.voltual.pyrolysis.HELP_CHANNEL
import me.voltual.pyrolysis.HELP_LICENSE
import me.voltual.pyrolysis.HELP_MATRIX
import me.voltual.pyrolysis.HELP_SOURCECODE
import me.voltual.pyrolysis.HELP_TELEGRAM
...
import me.voltual.pyrolysis.core.ui.icons.phosphor.BracketsSquare
import me.voltual.pyrolysis.core.ui.icons.phosphor.CalendarPlus
import me.voltual.pyrolysis.core.ui.icons.phosphor.CalendarX
import me.voltual.pyrolysis.core.ui.icons.phosphor.Copyleft
import me.voltual.pyrolysis.core.ui.icons.phosphor.GithubLogo
import me.voltual.pyrolysis.core.ui.icons.phosphor.ListBullets
import me.voltual.pyrolysis.core.ui.icons.phosphor.Megaphone
import me.voltual.pyrolysis.core.ui.icons.phosphor.TagSimple
import me.voltual.pyrolysis.core.ui.icons.phosphor.TelegramLogo

enum class InstallerType(@param:StringRes val titleResId: Int) {
...
enum class Order(@param:StringRes val titleResId: Int, val icon: ImageVector) {
