...
val Phosphor.CircleWavyQuestion: ImageVector
    get() {
        if (_circle_wavy_question != null) {
            return _circle_wavy_question!!
        }
        _circle_wavy_question = Builder(
...
private var _circle_wavy_question: ImageVector? = null
