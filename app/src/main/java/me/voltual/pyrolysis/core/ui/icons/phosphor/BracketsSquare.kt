...
val Phosphor.BracketsSquare: ImageVector
    get() {
        if (_brackets_square != null) {
            return _brackets_square!!
        }
        _brackets_square = Builder(
...
private var _brackets_square: ImageVector? = null
