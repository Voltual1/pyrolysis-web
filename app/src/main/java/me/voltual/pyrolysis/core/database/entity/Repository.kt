...
import me.voltual.pyrolysis.core.database.FdroidDatabase.Companion.TAG
import me.voltual.pyrolysis.core.utils.Utils.calculateSHA256
...
data class Repository(
    ...
    companion object {
       ...
       private val TUNA = defaultRepository(
            address = "https://mirrors.tuna.tsinghua.edu.cn/fdroid/repo",
            name = "F-Droid镜像(TUNA:清华大学开源软件镜像站)",
            description = "本站由清华大学信息化技术中心支持创办，由清华大学 TUNA 协会运行维护。TUNA 是由清华大学热爱网络技术和开源软件的极客组成的学生技术社团。",
            version = 21,
            enabled = true,
            fingerprint = "43238D512C1E5EB2D6569F4A3AFBF5523418B82E0A3ED1552770ABB9A9C9CCAB",
            authentication = "",
            webBaseUrl = "https://mirrors.tuna.tsinghua.edu.cn/fdroid/repo/",
