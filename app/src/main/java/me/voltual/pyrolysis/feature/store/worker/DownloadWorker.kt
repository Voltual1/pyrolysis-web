...
import me.voltual.pyrolysis.ARG_AUTHENTICATION
import me.voltual.pyrolysis.ARG_NAME
import me.voltual.pyrolysis.ARG_PACKAGE_NAME
import me.voltual.pyrolysis.ARG_RELEASE
import me.voltual.pyrolysis.ARG_REPOSITORY_ID
import me.voltual.pyrolysis.ARG_RESULT_CODE
import me.voltual.pyrolysis.ARG_STARTED
import me.voltual.pyrolysis.ARG_URL
import me.voltual.pyrolysis.ARG_VALIDATION_ERROR
...
import me.voltual.pyrolysis.data.entity.DownloadTask
...
import me.voltual.pyrolysis.manager.network.DownloadSizeException
import me.voltual.pyrolysis.manager.network.Downloader
import me.voltual.pyrolysis.manager.service.InstallerReceiver
import me.voltual.pyrolysis.core.utils.copyTo
import me.voltual.pyrolysis.core.utils.downloadNotificationBuilder
...
import me.voltual.pyrolysis.core.utils.notifySensitivePermissionsChanged
import me.voltual.pyrolysis.core.utils.updateWithError
...
class DownloadWorker(
    ...
    private suspend fun handleCancel() {
        ...
        updateDownloadState(state)
        Cache.eraseDownload(BBQApplication.context, task.release.cacheFileName)
        showPersistentNotification(state)
    }
