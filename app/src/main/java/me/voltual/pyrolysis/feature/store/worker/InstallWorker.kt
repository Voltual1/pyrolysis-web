...
import me.voltual.pyrolysis.ARG_FILE_NAME
...
import me.voltual.pyrolysis.core.database.entity.InstallTask
import me.voltual.pyrolysis.data.entity.InstallState
...
import me.voltual.pyrolysis.manager.installer.InstallationError
import me.voltual.pyrolysis.core.utils.extension.android.Android
import me.voltual.pyrolysis.core.utils.installNotificationBuilder
                    ...
                    is InstallState.Preparing -> {
                        if (!installer.isEnqueued(currentTask.packageName)) {
                            ...
                            try {
                                ...
                                if (installer.isLegacy() && BBQApplication.mainActivity != null) {
                                    BBQApplication.mainActivity?.withResumed {
                                        launch {
