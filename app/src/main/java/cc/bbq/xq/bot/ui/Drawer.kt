...
import cc.bbq.xq.bot.data.DrawerMenuDataStore
...
fun NavigationDrawerItems(
    ...
    val allDrawerItems = remember {
        listOf(
            ...
            DrawerItem("bot_settings", "机器人", R.drawable.android, BotSettings.route),
            DrawerItem("bot_logs", "机器人日志", R.drawable.work_log, LogViewer.route),
