// cc/bbq/xq/bot/ui/search/SearchViewModel.kt

package cc.bbq.xq.bot.ui.search
...
sealed class SearchResultItem {
    ...
    data class HistoryItem(val history: cc.bbq.xq.bot.ui.community.BrowseHistory) : SearchResultItem()
    data class LogItem(val log: cc.bbq.xq.bot.data.db.LogEntry) : SearchResultItem()
}
