...
public class ArscFile(public val packages: List<ArscPackage>) {
	...
	public fun finalize(): ByteArray {
		...
		val header = ArscHeader(ArscHeaderType.Table, ArscHeader.size().toUShort(), (ArscHeader.size() + globalBuffer.size).toUInt())
