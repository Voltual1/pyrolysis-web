...
public data class ArscStringPool(
    ...
    public val styles: List<ArscStyle>,
    ...
    public data class WrittenPool(
        public val strings: Map<String, Int>,
        public val styles: Map<ArscStyle, Int>,
    )
    ...
    public companion object {
        ...
        public fun parse(source: Source): ArscStringPool {
            ...
            repeat(stringsCount.toInt()) { body.readU32() }
            repeat(stylesCount.toInt()) { body.readU32() }
    ...
    return chars.concatToString()
        ...
        public fun write(sink: Sink, pool: ArscStringPool): WrittenPool {
            ...
            val baseOffset = 28 + (pool.strings.size * 4) + (pool.styles.size * 4)
            val totalSize = baseOffset + stringsBuffer.size.toInt()
            ArscHeader.write(sink, ArscHeader(ArscHeaderType.StringPool, 8u.toUShort(), totalSize.toUInt()))
            ...
            val stringMap = pool.strings.mapIndexed { i, s -> s to i }.toMap<String, Int>()
            return WrittenPool(stringMap, emptyMap<ArscStyle, Int>())
        }
